...
<mobile-tear-sheet>
  <mu-list>
    ...
    <mu-list-item title="这个周末一起吃饭么?">
      <mu-avatar src="http://yjb.xiongmaoyd.com/images/pic.png" slot="leftAvatar"/>
      <span slot="describe">
    ...
    <mu-list-item title="Alex Qin">
      <mu-avatar src="http://yjb.xiongmaoyd.com/images/pic02.png" slot="leftAvatar"/>
      <span slot="describe">
    ...
    <mu-list-item title="LOL">
      <mu-avatar src="http://yjb.xiongmaoyd.com/images/pic03.png" slot="leftAvatar"/>
      <span slot="describe">
